...
```{r plot_distributions, dependson="meta_distributions", fig.width=4, fig.height=2.3}
...
```{r plot_meta_distributions, dependson="meta_distributions", fig.height=3.3, fig.width=5.7}
...
```{r plot_list_functions, dependson="list_functions", fig.height=3.7, fig.width=2.5}
...
```{r plot_list_functions2, dependson="list_functions", fig.height=1.2, fig.width=6}
...
```{r plot_sampling, dependson="plot_sampling_fun", fig.height=2.5, fig.width=3.4}
...
```{r extract_ersatz, fig.height=2.5, fig.width=2.5}
...
```{r merge_plots_ersatz, dependson=c("extract_ersatz", "plot_sampling"), fig.width=6, fig.height=2.5}
...
```{r model, dependson=c("functions", "meta_distributions")}
...
```{r sample_matrix, dependson="model"}
...
```{r run_model, dependson="sample_matrix"}
...
```{r arrange_output, dependson="run_model"}
...
```{r plot_output, dependson="arrange_output", warning = FALSE, fig.height=2, fig.width=6}
...
```{r density_plot, dependson="arrange_output", fig.height=2, fig.width=6}
...
```{r refine_boxplots, dependson=c("plot_output", "density_plot"), fig.height=3, fig.width=6}
...
```{r boxplots_out, dependson="arrange_output", fig.width=6, fig.height=1.8}
...
```{r boxplots_samplesize, dependson="arrange_output", fig.width=6, fig.height=1.8}
...
```{r merge_scatters, dependson=c("plot_output", "boxplots_out"), fig.width=6, fig.height=3.8}

plot_grid(scatter.plot, scatter.d, ncol = 1, 
          labels = "auto", rel_heights = c(0.55, 0.45))
```

```{r pairwise_mood, dependson="arrange_output", fig.height=2.5, fig.width=6}
...
```{r scatter_mood, dependson=c("pairwise_mood", "plot_output", "refine_boxplots", "density_plot"), fig.height=5.5, fig.width=6}
...
```{r negative_algo, dependson="arrange_output"}
...
```{r run_negative, dependson="negative_algo"}
...
```{r plot_negative, dependson="run_negative", fig.height=2.8, fig.width=6}
...
```{r fraction_0_5, dependson=c("arrange_output", "sample_matrix"), fig.height=2.5, fig.width=3}
...
```{r plot_scatter, dependson="arrange_output", fig.height=6.3, fig.width=6}
...
```{r arrange_timing, dependson="computing_time"}
...
```{r plot_timing, dependson="arrange_timing", fig.height=2, fig.width=6, warning=FALSE}
...
```{r merge_plots, dependson=c("plot_output", "plot_timing"), fig.height=4, fig.width=6, warning=FALSE}
...
```{r all_boxplots, dependson=c("plot_timing", "plot_output"), fig.height=3, fig.width=6, warning=FALSE}
...
```{r merge_scatter_box, dependson=c("all_boxplots", "merge_plots"), fig.height=5.5, fig.width=6, warning=FALSE}
...
```{r arrange_time_complexity, dependson="time_complexity"}
...
```{r plot_time_complexity, dependson="arrange_time_complexity", fig.height=1.8, fig.width=4.5}
